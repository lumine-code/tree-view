...
class TreeView {
  ...
  // The tree's own rows are served by `open-external`, whose Show in Folder
  // covers every one of them and takes the whole selection rather than just
  // the first path. This one stays because that package's menu reaches no
  // further than the tree and the image and PDF views.
