module.exports = class RootDragAndDropHandler {
  constructor(treeView) {
    ...
    this.windowEventSubscription = atom.window.onDidReceive(
  ...
  onDrop(e) {
    ...
    if (fromWindowId === this.getWindowId()) {
      ...
      if (!isNaN(fromWindowId)) {
        ...
        void atom.window.broadcast("tree-view:project-folder-dropped", {
  ...
  getWindowId() {
    return this.windowId != null ? this.windowId : (this.windowId = atom.window.getId());
  }
};
